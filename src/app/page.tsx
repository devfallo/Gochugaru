...
const content = {
  ko: {
    ...
    recipes: [
      ...
      { name: '순두부찌개', imageUrl: 'https://images.unsplash.com/photo-1626082382339-b552a849a15f?q=80&w=2070&auto=format&fit=crop', ingredients: ['순두부 1봉', '다진 돼지고기 50g', '김치 50g', '양파 1/4개', '계란 1개', '고추가루 2큰술', '다진 마늘 1큰술', '국간장 1큰술', '참기름 1큰술', '멸치육수 200ml'], instructions: ['뚝배기에 참기름을 두르고 다진 돼지고기, 김치, 양파를 볶습니다.', '고추가루를 넣고 볶아 고추기름을 낸 후 멸치육수를 붓고 끓입니다.', '국물이 끓으면 순두부를 넣고 숟가락으로 큼직하게 나눕니다.', '국간장과 다진 마늘로 간을 맞춘 후 계란을 깨뜨려 넣고 대파를 뿌려 완성합니다.'], tips: '바지락이나 새우를 추가하면 해물 순두부찌개로 즐길 수 있습니다. 밥에 비벼 먹을 때 김가루를 뿌리면 더욱 맛있습니다.' },
